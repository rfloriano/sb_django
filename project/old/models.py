...
class Clientes(models.Model):
    ...
    nivel = models.IntegerField(null=True, blank=True)
    provedor_scan = models.IntegerField(null=True, blank=True, choices=PROVEDOR_SCAN)
    provedor_scan_ip = models.IntegerField(null=True, blank=True, choices=PROVEDOR_SCAN_IP)
    ...
    def save(self, *args, **kwargs):
        self.provedor_scan_ip = 1  # default is AVDS
...
class Estatisticas(models.Model):
    ...
    dispositivo = models.ForeignKey("migration.Dispositivos", null=True, blank=True)
...
class HaScanStatus(models.Model):
    ...
    scan_request_hostname = models.CharField(max_length=255, blank=True, null=True)
    ...
    scan = models.ForeignKey("migration.Scans", null=True, blank=True)
    class Meta:
...
class Logs(models.Model):
    ...
    scan = models.ForeignKey("migration.Scans", related_name="scan_logs", null=True, blank=True)
    data_criacao = models.DateTimeField(null=True, blank=True)
    created_at = models.DateTimeField(null=True, blank=True)
    updated_at = models.DateTimeField(null=True, blank=True)
    class Meta:
...
class Pesquisas(models.Model):
    ...
    dispositivo = models.ForeignKey("migration.Dispositivos", related_name="dispositivo_pesquisas", null=True, blank=True)
    created_at = models.DateTimeField(null=True, blank=True)
    updated_at = models.DateTimeField(null=True, blank=True)
